...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { board_id: @pin.board_id, image: @pin.image, name: @pin.name } }
    end

    assert_redirected_to pin_path(Pin.last)
  end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { board_id: @pin.board_id, image: @pin.image, name: @pin.name } }
